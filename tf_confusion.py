...
def get_parameter():
  ...
  return hmin,hc,hmax,nSteps,bSize,nNodes1,fValidate,rLearn,lrDecay,beta,tCycles
...
if __name__ == '__main__':
  ...
  parser.add_argument('--h_c', type=float, default=0.25,
                      help='critical h')
