...
#        temp_l2 = sess.run(l2_loss, feed_dict={x: batch_xs[i], y_: batch_ys[i]})
        ...
        print(hc,nstep + 1,temp_acc,temp_ce,temp_l2,temp_ce/temp_l2,beta,rLearn)
...
if __name__ == '__main__':
  ...
  parser.add_argument('--h_step', type=float, default=0.03125,
                      help='step of h')
  parser.add_argument('--h_range', type=float, default=0.25,
                      help='range of h (single side)')
